...
namespace BethanysPieShopHRM.App.Pages
{
    public class EmployeeDetailBase : ComponentBase
    {
        ...
        protected override Task OnInitializedAsync()
        {
            ...
            /**
             * We are fetching the employee data based on the employee id provided
        ...
        /**
         * We are adding the Parameter attribute since this property is used as 
         * parameter in the component url and this will automatically be filled
         * up by Blazor.
         */
        [Parameter]
        ...
        /**
         * We are creating a property of type Employee that we are going to bind
         * to the UI
         */
